...
<body>
    ...
    <h1 style="color:beige">ACUMEN IT 2K18</h1>
<div id="svgbox"> 
...
<style>
    ...
    .item .sector {
        transition: all .1s linear; fill: rgba(255, 255, 255, 1); stroke: #ddd;}
...
<g id="itemsContainer" data-svg-origin="250 250" transform="matrix(0.38734, -0.92193, 0.92193, 0.38734, -77.3193578290572, 383.64893561257276)">
    ...
    <a  class="item" id="item-4" href="pages/events.html" xlink:href=" " xlink:title=" " transform="matrix(-0.7071,-0.7071,0.7071,-0.7071,249.99999999999997,603.5533905932738)" data-svg-origin="250 250" style="">     <circle class="sector" cx="250" cy="250" r="40" />
    ...
    <a  class="item" id="item-8" href="pages/archive.html" xlink:href=" " xlink:title=" " transform="matrix(0.7071,0.7071,-0.7071,0.7071,250.00000000000009,-103.55339059327378)" data-svg-origin="250 250" style="">
        <circle class="sector" cx="250" cy="250" r="40" />
...
<g id="trigger" class="trigger menu-trigger">
    <circle id="animCircle" cx = "50%" cy = "50%" r = "40" fill="none" style="stroke-width:3px" stroke="#ada4a4">
        <animate attributeName="r" begin="0s" dur="1.2s" repeatCount="indefinite" from="40" to="50"/>
    </circle>
    <circle id="outer" cx="250" cy="250" r="70" fill="red"></circle>
    <circle id="inner" cx="250" cy="250" r="65" fill="#000"></circle>
    <text id="label" text-anchor="middle" transform="rotate(0,250,250)" alignment-baseline="central" x="250" y="250" fill="#000" font-size="1.5em">ACUMEN</text>
</g>
    <animateTransform 
           xlink:href="#menu"
    ...
    <p id="sd-indicator" style="left:0"><i class="fa">&#xf103;</i> Scroll Down <i class="fa">&#xf103;</i></p>
    <p id="sd-indicator" style="right:0"><i class="fa">&#xf103;</i> Scroll Down <i class="fa">&#xf103;</i></p>
    <br>
    <div id="about-content">
        <img id="logo" src="img/logo/2k17.jpg">
        <div id="content-text">
        ...
        <br>
        <div id="footer">
            <h3 style="color: black;position: relative;left: 0;right: 0;margin: auto">Follow us on</h3>
        ...
        <a target="_blank" href="#" class="fa fa-envelope-square"></a>
            <h2 style="color:black"><strong>Hit count : 
